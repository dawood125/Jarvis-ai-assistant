...
function ChatStage({ messages }) {
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto pr-4 mb-6 flex flex-col gap-6 scrollbar-thin scrollbar-thumb-[#00f3ff]/20 scrollbar-track-transparent">
      ...
      <motion.form 
        whileFocus={{ boxShadow: '0 0 20px rgba(0,243,255,0.2)' }}
